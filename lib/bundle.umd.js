(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('apollo-link'), require('sha.js'), require('graphql/language/printer')) :
	typeof define === 'function' && define.amd ? define(['exports', 'apollo-link', 'sha.js', 'graphql/language/printer'], factory) :
	(factory((global.persistedQueryLink = {}),global.apolloLink,global.sha_js,global.graphql_language_printer));
}(this, (function (exports,apolloLink,sha_js,graphql_language_printer) { 'use strict';

var VERSION = 1;
var defaultGenerateHash = function (query) {
    return new sha_js.sha256().update(graphql_language_printer.print(query)).digest('hex');
};
var defaultOptions = {
